...
export const metadata: Metadata = {
  title: 'Доставка СДЭК | Магазин',
  description: 'Информация о доставке товаров Магазин курьерской службой СДЭК по всей России',
}
        ...
        <div className="container" style={{ maxWidth: 800 }}>
          ...
          <div className="tile" style={{ padding: 32, background: 'var(--accent)', color: '#fff' }}>
            ...
            <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
              <a href="mailto:shop@getnwin.ru" className="btn" style={{ background: '#fff', color: '#000' }}>
                shop@getnwin.ru
              </a>
