            ...
            <div style={{display:'grid',gap:32}}>
              <section>
                ...
                <div className="lead" style={{fontSize:'16px',lineHeight:1.6,display:'grid',gap:12}}>
                  <p><strong>Продавец:</strong> ООО «ФЛАЙТ», ИНН 5403087589, ОГРН 1255400011261, адрес: 630088, Новосибирская область, г. Новосибирск, ул. Петухова, д. 22/1.</p>
                  <p><strong>Агент Продавца:</strong> ИП Гладких Виталий Олегович, ИНН 381705889083, ОГРНИП 325774600805724.</p>
              ...
              <section>
                ...
                <div className="lead" style={{fontSize:'16px',lineHeight:1.6,display:'grid',gap:12}}>
                  ...
                  <p>ООО «ФЛАЙТ»<br/>
                  ИНН: 5403087589<br/>
                  ОГРН: 1255400011261<br/>
                  Адрес: 630088, Новосибирская область, г. Новосибирск, ул. Петухова, д. 22/1<br/>
