            ...
            <div style={{display:'grid',gap:32}}>
              <section id="terms">
                ...
                <div className="lead" style={{fontSize:'16px',lineHeight:1.6,display:'grid',gap:12}}>
                  <p><strong>Оператор площадки</strong> — ИП Гладких Виталий Олегович, ИНН 381705889083, ОГРНИП 325774600805724.</p>
                  <p><strong>Организатор/Продавец</strong> — ООО «ФЛАЙТ», ИНН 5403087589, ОГРН 1255400011261.</p>
