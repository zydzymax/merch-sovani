        ...
        <div className="container" style={{maxWidth:900}}>
          ...
          <div style={{display:'grid',gap:24}}>
            ...
            <div className="tile" style={{padding:40}}>
              ...
              <div style={{marginTop:24,padding:20,background:'var(--surface)',borderRadius:16,borderLeft:'4px solid var(--accent)'}}>
                <p className="lead" style={{fontSize:'14px',lineHeight:1.6,opacity:0.9,margin:0}}>
                  <strong>Роль Организатора:</strong> Организатор является продавцом товаров, организатором стимулирующей акции «Выиграй iPhone 17 Pro Max», определяет победителей, вручает призы и уплачивает НДФЛ 35% с призов в соответствии с п. 2 ст. 224 НК РФ.
                </p>
              </div>
            </div>
                ...
                <section>
                  ...
                  <div className="lead" style={{fontSize:'16px',lineHeight:1.6,display:'grid',gap:12}}>
                    ...
                    <ul style={{paddingLeft:24}}>
                      ...
                      <li>Определение победителей с публикацией результатов в Instagram*;</li>
