# 📋 SoVAni MVP v2.0 - Итоговый отчет
...
- ✅ 6 товаров SoVAni (футболка, лонгслив, худи, штаны, 2 БАД)
- ✅ 3 тира билетов
- ✅ 3 новогодних приза (iPhone, сертификат, AirPods, набор)
- ✅ 1 активный розыгрыш
...
1. **Главная страница** (`/`)
   ...
   - Блок "Хиты продаж" (6 товаров SoVAni из БД)
